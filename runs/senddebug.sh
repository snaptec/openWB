...
grep -F -v -e leaf -e i3 -e zoe -e tesla -e carnet -e settingspw -e wrsunwayspw -e cloudpw -e wr_piko2_pass -e zerong -e discovergy -e audi -e smartme -e bydhvpass -e lgessv1pass -e myrenault -e bluelink -e  /var/www/html/openWB/openwb.conf >> $debugFile
