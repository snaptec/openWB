...
then
	...
	echo "soc_eq_cb_lp1=http://openWB/openWB/modules/soc_eq/callback_lp1.php" >> /var/www/html/openWB/openwb.conf
	...
	echo "soc_eq_cb_lp2=http://openWB/openWB/modules/soc_eq/callback_lp2.php" >> /var/www/html/openWB/openwb.conf
fi
...
if ! grep -Fq "solaxip=" /var/www/html/openWB/openwb.conf
then
