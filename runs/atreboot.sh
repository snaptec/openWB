...
echo 0 > /var/www/html/openWB/ramdisk/mqttwaitautolocklp1
echo 0 > /var/www/html/openWB/ramdisk/mqttwaitautolocklp2
echo 0 > /var/www/html/openWB/ramdisk/mqttwaitautolocklp3
echo 0 > /var/www/html/openWB/ramdisk/mqttwaitautolocklp4
echo 0 > /var/www/html/openWB/ramdisk/mqttwaitautolocklp5
echo 0 > /var/www/html/openWB/ramdisk/mqttwaitautolocklp6
echo 0 > /var/www/html/openWB/ramdisk/mqttwaitautolocklp7
echo 0 > /var/www/html/openWB/ramdisk/mqttwaitautolocklp8
