...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}12.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}11.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}10.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}09.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}08.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}07.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}06.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}05.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}04.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}03.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}02.csv ] 
then
...
if [ -s /var/www/html/openWB/web/logging/data/monthly/${input}01.csv ] 
then
