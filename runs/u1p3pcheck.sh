...
if [[ "$1" == "1" ]]; then
	...
	if [[ $evsecon == "ipevse" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp1}" "${u1p3plp2id}" 1 "${u1p3ppause}"
	fi
	...
	if [[ $lastmanagement == 1 && $evsecons1 == "ipevse" && $u1p3plp2aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp2}" "${u1p3plp2id}" 1 "${u1p3ppause}"
	fi
	...
	if [[ $lastmanagements2 == 1 && $evsecons2 == "ipevse" && $u1p3plp3aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp3}" "${u1p3plp3id}" 1 "${u1p3ppause}"
	fi
	# chargepoint 4
	...
	if [[ $lastmanagementlp4 == 1 && $evseconlp4 == "ipevse" && $u1p3plp4aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp4}" "${u1p3plp4id}" 1 "${u1p3ppause}"
	fi
	# chargepoint 5
	...
	if [[ $lastmanagementlp5 == 1 && $evseconlp5 == "ipevse" && $u1p3plp5aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp5}" "${u1p3plp5id}" 1 "${u1p3ppause}"
	fi
	# chargepoint 6
	...
	if [[ $lastmanagementlp6 == 1 && $evseconlp6 == "ipevse" && $u1p3plp6aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp6}" "${u1p3plp6id}" 1 "${u1p3ppause}"
	fi
	# chargepoint 7
	...
	if [[ $lastmanagementlp7 == 1 && $evseconlp7 == "ipevse" && $u1p3plp7aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp7}" "${u1p3plp7id}" 1 "${u1p3ppause}"
	fi
	# chargepoint 8
	...
	if [[ $lastmanagementlp8 == 1 && $evseconlp8 == "ipevse" && $u1p3plp8aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp8}" "${u1p3plp8id}" 1 "${u1p3ppause}"
	fi
...
if [[ "$1" == "3" ]]; then
	...
	if [[ $evsecon == "ipevse" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp1}" "${u1p3plp2id}" 3 "${u1p3ppause}"
	fi
	if [[ $lastmanagement == 1 && $evsecons1 == "ipevse" && $u1p3plp2aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp2}" "${u1p3plp2id}" 3 "${u1p3ppause}"
	fi
	if [[ $lastmanagements2 == 1 && $evsecons2 == "ipevse" && $u1p3plp3aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp3}" "${u1p3plp3id}" 3 "${u1p3ppause}"
	fi
	if [[ $lastmanagementlp4 == 1 && $evseconlp4 == "ipevse" && $u1p3plp4aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp4}" "${u1p3plp4id}" 3 "${u1p3ppause}"
	fi
	if [[ $lastmanagementlp5 == 1 && $evseconlp5 == "ipevse" && $u1p3plp5aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp5}" "${u1p3plp5id}" 3 "${u1p3ppause}"
	fi
	if [[ $lastmanagementlp6 == 1 && $evseconlp6 == "ipevse" && $u1p3plp6aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp6}" "${u1p3plp6idp}" 3 "${u1p3ppause}"
	fi
	if [[ $lastmanagementlp7 == 1 && $evseconlp7 == "ipevse" && $u1p3plp7aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp7}" "${u1p3plp7id}" 3 "${u1p3ppause}"
	fi
	if [[ $lastmanagementlp8 == 1 && $evseconlp8 == "ipevse" && $u1p3plp8aktiv == "1" ]]; then
		python3 /var/www/html/openWB/packages/modules/cp/satellite.py 3 "${evseiplp8}" "${u1p3plp8id}" 3 "${u1p3ppause}"
	fi
