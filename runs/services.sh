...
. "$OPENWBBASEDIR/runs/remoteSupport/remoteSupportHelper.sh"

stop() {
	openwbDebugLog "MAIN" 0 "Stopping OpenWB services"
	local service_pattern='^python.*/(modbusserver|smarthomehandler|smarthomemq|mqttsub|isss|buchse|legacy_run_server|rseDaemon|pushButtonsDaemon|rfidDaemon|readrfid|remoteSupport)\.py'
