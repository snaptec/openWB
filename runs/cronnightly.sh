...
# monthly . csv updaten
python3 /var/www/html/openWB/runs/csvcalc.py /var/www/html/openWB/web/logging/data/daily/ /var/www/html/openWB/web/logging/data/excel/ /var/www/html/openWB/ramdisk/ A >> /var/www/html/openWB/ramdisk/csvcalc.log 2>&1 &
