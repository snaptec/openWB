...
if Debug >= 2:
    DebugLog('EVU LG IP: ' + lg_ess_ip)
    DebugLog('EVU LG Passwort: ' + lg_ess_pass)
    DebugLog('EVU LG Version: ' + lg_ess_api_ver)
...
if Debug >= 1:
    DebugLog('EVU Leistung: ' + str(grid_power))
    DebugLog('Imp/Exp: ' + str(is_grid_selling))
