      ...
      # counter values
        ...
        if measurement in sma_channels.keys():
          ...
          if revision=="1":
              ...
              #A â€“ Alpha (noch kein Feature Complete, Version fÃ¼r Verifizierung und Validierung)
              version=version+".A"
          elif revision=="3":
              #B â€“ Beta (Feature Complete, Version fÃ¼r Verifizierung und Validierung)
              version=version+".B"
          elif revision=="4":
              #R â€“ Release Candidate / Release (Version fÃ¼r Verifizierung, Validierung und Feldtest / Ã¶ffentliche Version)
              version=version+".R"
          elif revision=="5":
              #E â€“ Experimental Version (dient zur lokalen Verifizierung)
              version=version+".E"
          elif revision=="6":
              #N â€“ Keine Revision
              version=version+".N"
