...
if [[ $solaredgepvslave3 != "none" ]] && [[ $solaredgepvslave4 != "none" ]]&& [[ $solaredgepvslave2 != "none" ]]; then
	sudo python /var/www/html/openWB/modules/wr_solaredge/solaredge4.py $solaredgepvip $solaredgepvslave1 $solaredgepvslave2 $solaredgepvslave3 $Solaredgebatwr $solaredgepvslave4
else
