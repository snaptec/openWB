...
time_string = time.strftime("%m/%d/%Y, %H:%M:%S myrenault lp1", named_tuple) 
...
#print ('c1',reg)
f = open('/var/www/html/openWB/ramdisk/zoereq1lp1', 'w')
f.write(str(reg))
f.close()
...
f = open('/var/www/html/openWB/ramdisk/zoereq3lp1', 'w')
f.write(str(reg))
f.close()
#print('c3',reg)
response= urllib2.urlopen(reg)
responsetext  = response.read()
f = open('/var/www/html/openWB/ramdisk/zoereply3lp1', 'w')
f.write(str(responsetext))
f.close()
...
f = open('/var/www/html/openWB/ramdisk/zoereq4lp1', 'w')
f.write(str(reg))
f.close()
#print('c4',reg)
response= urllib2.urlopen(reg)
responsetext  = response.read()
f = open('/var/www/html/openWB/ramdisk/zoereply4lp1', 'w')
f.write(str(responsetext))
f.close()
...
response= urllib2.urlopen(reg)
responsetext  = response.read()
f = open('/var/www/html/openWB/ramdisk/zoereply5lp1', 'w')
f.write(str(responsetext))
f.close()
...
response= urllib2.urlopen(reg)
responsetext  = response.read()
f = open('/var/www/html/openWB/ramdisk/zoereply6lp1', 'w')
f.write(str(responsetext))
f.close()
...
response= urllib2.urlopen(reg)
responsetext  = response.read()
f = open('/var/www/html/openWB/ramdisk/zoereply8lp1', 'w')
f.write(str(responsetext))
f.close()
...
response= urllib2.urlopen(reg)
responsetext  = response.read()
f = open('/var/www/html/openWB/ramdisk/zoereply9lp1', 'w')
f.write(str(responsetext))
f.close()
