...
if Debug >= 2:
    DebugLog('Speicher IP: ' + lg_ess_ip)
    DebugLog('Speicher Passwort: ' + lg_ess_pass)
    DebugLog('Speicher Version: ' + lg_ess_api_ver)
...
if Debug >= 1:
    DebugLog('Speicher Leistung: ' + str(battery_power))
    DebugLog('Speicher SoC: ' + str(bat_user_soc))
