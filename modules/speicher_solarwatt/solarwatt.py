...
if solarwattmethod == 0:  # Abruf über Energy Manager
    ...
    speichere=get_value("PowerConsumedFromStorage")
    speicherein=get_value("PowerOutFromStorage")
    speicheri=get_value("PowerBuffered")
    speicherleistung=int((speichere + speicherin - speicheri) *-1)
    speichersoc=get_value("StateOfCharge")
