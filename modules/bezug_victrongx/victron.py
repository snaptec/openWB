...
#grid ampere
resp= client.read_holding_registers(2617,1,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
a1 = str(decoder.decode_16bit_int())
a1 = float(a1) / 10
resp= client.read_holding_registers(2619,1,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
a2 = str(decoder.decode_16bit_int())
a2 = float(a2) / 10
resp= client.read_holding_registers(2621,1,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
...
#grid voltage
resp= client.read_holding_registers(2616,1,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
v1 = str(decoder.decode_16bit_uint())
v1 = float(v1) / 10
resp= client.read_holding_registers(2618,1,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
v2 = str(decoder.decode_16bit_uint())
v2 = float(v2) / 10
resp= client.read_holding_registers(2620,1,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
...
#grid import
resp= client.read_holding_registers(2622,2,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
wh1 = str(decoder.decode_32bit_uint())
resp= client.read_holding_registers(2624,2,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
wh2 = str(decoder.decode_32bit_uint())
resp= client.read_holding_registers(2626,2,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
...
#grid export
resp= client.read_holding_registers(2628,2,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
whe1 = str(decoder.decode_32bit_uint())
resp= client.read_holding_registers(2630,2,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
whe2 = str(decoder.decode_32bit_uint())
resp= client.read_holding_registers(2632,2,unit=30)
decoder = BinaryPayloadDecoder.fromRegisters(resp.registers,byteorder=Endian.Big,wordorder=Endian.Big)
