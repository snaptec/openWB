...
speicherewh=$(curl -s "http://x:user@$femsip:8084/rest/channel/ess0/ActiveChargeEnergy" | jq .value)
speicheriwh=$(curl -s "http://x:user@$femsip:8084/rest/channel/ess0/ActiveDischargeEnergy" | jq .value)
