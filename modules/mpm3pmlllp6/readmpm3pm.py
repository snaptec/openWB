...
with ModbusTcpClient(ipadd, port=8899) as client:
    if (idadd < 100):
        ...
        write_to_ramdisk("llkwhlp6", llkwh)
        resp = client.read_input_registers(0x0E, 2, unit=idadd)
        ...
        if llg < 10:
            llg = 0
        write_to_ramdisk("llaktuelllp6", llg)
