...
?>
	...
	<script src="themes/<?php echo $themeCookie ?>/livechart_chartjs.js?version=9"></script>
	<!-- Data refresher -->
	<script src="themes/<?php echo $themeCookie ?>/live.js?vers=14"></script>
	<script src="themes/<?php echo $themeCookie ?>/livefunctions.js?vers=7"></script>
</body>
