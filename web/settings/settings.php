						...
						<div id="durchslp1div">
							<div class="form-group">
								...
								<div class="form-row mb-1">
									...
									<div class="col">
										<input class="form-control" type="text" name="durchslp1" id="durchslp1" value="<?php echo $durchslp1old ?>">
								...
								<div class="form-row mb-1">
									...
									<div class="col">
										<input class="form-control" type="text" name="akkuglp1" id="akkuglp1" value="<?php echo $akkuglp1old ?>">
						...
						<div id="durchslp2div">
							...
							<div class="form-group mb-1">
								...
								<div class="form-row vaRow mb-1">
									...
									<div class="col">
										<input class="form-control" type="text" name="durchslp2" id="durchslp2" value="<?php echo $durchslp2old ?>">
										<span class="form-text small">Gültige Werte xx.xx, z.B. 14.5. Dient zur Berechnung der geladenen Strecke.</span>
									</div>
								</div>
								<div class="form-row vaRow mb-1">
									...
									<div class="col">
										<input class="form-control" type="text" name="akkuglp2" id="akkuglp2" value="<?php echo $akkuglp2old ?>">
										<span class="form-text small">Gültige Werte xx, z.B. 41. Dient zur Berechnung der benötigten Ladezeit.</span>
									</div>
								</div>
							</div>
						...
						<div id="durchslp3div">
							...
							<div class="form-group">
								...
								<div class="form-row vaRow mb-1">
									...
									<div class="col">
										<input class="form-control" type="text" name="durchslp3" id="durchslp3" value="<?php echo $durchslp3old ?>">
										<span class="form-text small">Gültige Werte xx.xx, z.B. 14.5. Dient zur Berechnung der geladenen Strecke.</span>
									</div>
								</div>
							</div>
					...
					<div class="card-body">
						...
						<div id="u1p3pan">
							...
							<div class="form-group">
								...
								<div class="form-row mb-1">
									<label for="schieflastmaxa" class="col-4 col-sm-4 col-form-label">Schieflastbegrenzung</label>
									<div class="col-md-8">
										<div class="form-row vaRow mb-1">
					...
					<div class="card-body">
						<div class="form-group">
									...
									<div class="form-row">
										<div class="col-sm-4">
											<label for="lastmaxap1" class="input-group">
												...
												<input type="text" name="lastmaxap1" id="lastmaxap1" class="form-control" value="<?php echo trim( $lastmaxap1old ) ?>">
											</label>
										</div>
										<div class="col-sm-4">
											<label for="lastmaxap2" class="input-group">
												...
												<input type="text" name="lastmaxap2" id="lastmaxap2" class="form-control" value="<?php echo trim( $lastmaxap2old ) ?>">
											</label>
										</div>
										<div class="col-sm-4">
											<label for="lastmaxap3" class="input-group">
												...
												<input type="text" name="lastmaxap3" id="lastmaxap3" class="form-control" value="<?php echo trim( $lastmaxap3old ) ?>">
											</label>
										</div>
									</div>
							...
							<div class="form-row mb-1">
								...
								<div class="col">
									<input class="form-control" type="text" name="lastmmaxw" id="lastmmaxw" value="<?php echo $lastmmaxwold ?>">
						...
						<div id="loadsharingdiv">
							<div class="form-group">
								...
								<div class="form-row mb-1">
									...
									<div class="col">
										<div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
											<label class="btn btn-outline-info<?php if($loadsharingalp12old == 0) echo " active" ?>">
												<input type="radio" name="loadsharingalp12" id="loadsharingalp1216" value="0"<?php if($loadsharingalp12old == 0) echo " checked=\"checked\"" ?>>16 Ampere
											</label>
											<label class="btn btn-outline-info<?php if($loadsharingalp12old == 1) echo " active" ?>">
												<input type="radio" name="loadsharingalp12" id="loadsharingalp1232" value="1"<?php if($loadsharingalp12old == 1) echo " checked=\"checked\"" ?>>32 Ampere
											</label>
										</div>
										<span class="form-text small">
