				...
				<form action="./tools/savemain.php" method="POST">
					...
					<div id="durchslp2">
						...
						<div class="row bg-info">
							<div class="col">
								...
								Gültige Werte xx, z.B. 41 <br> Dient zur Berechnung der benötigten Ladezeit.<br>
							</div>
						</div>
					</div>
					<div id="durchslp3">
					...
					<div class="row" style="background-color:#00ada8">
						<div class="col">
							...
							<label for="nlakt_standby">Aktiv im Standby Lademodus</label><br><br>
						</div>
					</div><br>
					<div class="row" style="background-color:#00ada8">
						<div class="col">
					...
					<div class="row" style="background-color:#e6ccb3">
						<div class="col">
							...
							Durch das Drehen der Phasen ist sichergestellt, dass 2 einphasige Autos mit voller Geschwindigkeit laden können.<br><br>
						</div>
					</div>
