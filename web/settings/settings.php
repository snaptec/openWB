							...
							<div id="tibberdiv" class="hide">
								...
								<div class="card-text alert alert-primary">
									...
									<p>
										...
										in das Eingebafeld selbst eintragen oder durch Klick auf den Button von der openWB ermitteln lassen. Unerlaubte Zeichen werden aus dem Token und der Home-ID automatisch gelöscht.
									</p>
									<p>
