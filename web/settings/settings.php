			...
			<form action="./tools/savemain.php" method="POST">
				<div class="card border-secondary">
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col">
								Ermöglicht Laden nach Strompreis. Hierfür benötigt wird der Awattar Hourly Tarif sowie ein Discovergy Zähler.<br>
								Die Awattar Funktion ist nur im SofortLaden Modus aktiv!
							</div>
						</div>
						<div class="row ">
							<div class="col">
