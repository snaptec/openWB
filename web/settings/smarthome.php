		...
		<?php
			...
			foreach($lines as $line) {
				...
				if(strpos($line, "abgesteckthooklp1_url=") !== false) {
					list(, $abgesteckthooklp1_urlold) = explode("=", $line, 2);
				}
				...
				if(strpos($line, "abgesteckthooklp1=") !== false) {
					list(, $abgesteckthooklp1old) = explode("=", $line, 2);
				}
			...
			$abgesteckthooklp1_urlold = str_replace( "'", "", $abgesteckthooklp1_urlold);
