					...
					<div class="card-body">
						...
						<div id="socmpass">
							<div class="row">
								...
								<input type="password" name="socpass" id="socpass" value="<?php echo $socpassold ?>">
							</div>
							<div class="row">
								Passwort
							</div>
						...
						<div id="lastmman">
							...
							<div id="socmpass2">
								<div class="row">
									...
									<input type="password" name="soc2pass" id="soc2pass" value="<?php echo $soc2passold ?>">
								</div>
								<div class="row">
									Passwort
								</div>
				...
				<div class="card border-danger">
					...
					<div class="card-body">
						...
						<div id="wattbezugfronius">
							<div class="row"> Die IP des Wechselrichters wird im dazugehörigen Fronius PV-Modul eingestellt.
							</div>
				...
				<div class="card border-warning">
					...
					<div class="card-body">
						...
						<div id="divspeichermqtt">
							<div class="row">Keine Konfiguration erforderlich</div>
							<div class="row">Per MQTT zu schreiben:</div>
							<div class="row"><b>"openWB/set/houseBattery/W"</b></div>
							<div class="row">Speicherleistung in Watt, int, positiv Ladung, negativ Entladung</div>
							<div class="row"><b>"openWB/set/houseBattery/WhImported"</b></div>
							<div class="row">Geladene Energie in Wh, float, nur positiv</div>
							<div class="row"><b>"openWB/set/houseBattery/WhExported"</b></div>
							<div class="row">Entladene Energie in Wh, float, nur positiv</div>
							<div class="row"><b>"openWB/set/houseBattery/%Soc"</b></div>
							<div class="row">Ladestand des Speichers, int, 0-100</div>
						</div>
