						...
						<div class="form-group soclp12options">
							...
							<div class="form-row mb-1">
								...
								<div class="col">
									...
									<span class="form-text small">Auswahl der adaptiven Ladung im Modus PV-Laden. Die adaptive Ladung versucht, die zur Verfügung stehende Ladeleistung so aufzuteilen, dass bei zwei ladenden EV demjenigen mit dem geringeren SoC eine größere Ladeleistung zugewiesen wird. Die Gewichtung der Ladeleistung ist abhängig von der Einstellung "adaptiver Regelfaktor". Diese Einstellung beinflusst die Regelung nur dann, wenn zwei EV gleichzeitig laden, für beide ein SoC verfügbar ist und beide EV mit derselben Anzahl an Phasen laden.</span>
								</div>
							</div>
							<div class="form-row mb-1">
						...
						<div class="form-group">
							...
							<div class="form-row mb-1 nurpv70options">
								...
								<div class="col">
									...
									<span class="form-text small">Parameter in Watt [W] für den 70%-Regelpunkt im Modus PV-Laden. Dieser Parameter ist nur wirksam bei der Einstellung "70%-Regelung eingeschaltet". Der hier eingetragene Wert sollte zur optimalen Eigenverbrauchssteuerung 70 % der installierten kWp betragen.</span>
								</div>
							</div>
						</div>
						...
						<div class="form-group onlysoclp1options">
							...
							<div class="form-row mb-1">
								...
								<div class="col-md-8">
									...
									<span class="form-text small">Parameter in Prozent [%] für den Maximal-SoC am LP1 im Modus PV-Laden. Definiert einen EV-Maximal-SoC, bis zu dem höchstens geladen wird.</span>
								</div>
							</div>
						</div>
						<div class="form-row">
