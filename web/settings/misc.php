						...
						<div id="rfidandiv">
							...
							<div class="form-group mb-1">
								<div class="form-row">
									<div class="col">
										Lademodus ändern
										<span class="form-text small">Kann auch in Kombination mit einem RFID Tag zur Autozuweisung genutzt werden.</span>
									</div>
								</div>
							</div>
							<div class="form-group mb-1">
					...
					<div class="card-body">
						...
						<div id="displayan">
							...
							<div class="form-group">
								...
								<div class="form-row vaRow mb-1">
									<label for="displaypincode" class="col-md-4 col-form-label">Pin (4-stellig, nur Zahlen erlaubt von 1-9)</label>
									<div class="col">
