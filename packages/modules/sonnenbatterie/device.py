...
from modules.sonnenbatterie import bat, counter, inverter
from modules.sonnenbatterie.config import (SonnenBatterie, SonnenbatterieBatSetup, SonnenbatterieCounterSetup,
