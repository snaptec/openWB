...
class RCT():
    ...
    def read(self, idList):
        ...
        while(frame.pendingCount > 0):
            ...
            self.dbglog("Response: requested {:4d} | consumed {:4d} | dropped {:4d} | duplicate {:4d} | Crc16Error {:4d} | pending {:4d}".format(
                requestedCount, frame.statisticRxConsumed, frame.statisticRxDropped, frame.statisticRxDuplicate, frame.statisticCrc16Error, frame.pendingCount))
...
#                    self.dbglog("field " + str(fnn) + " val is:" + str(val) + " oldval:" + str(oldv) + " " + str(rctname))
    ...
    def id_tab_setup(self):
        ...
        self.id_tab.append(
            rct_id(0x011F41DB, 1, "power_mng.schedule[0]", rct_data.t_string, "power_mng.schedule[0]"))
        self.id_tab.append(rct_id(0x016109E1, 2, "grid_mon[0].u_over.time",
                           rct_data.t_float, "Max. voltage switch-off time level 1 [s]"))
        self.id_tab.append(
            rct_id(0x01676FA6, 3, "battery.cells_stat[3]", rct_data.t_string, "battery.cells_stat[3]"))
        self.id_tab.append(rct_id(0x019C0B60, 4, "cs_neg[2]",
                           rct_data.t_float, "Miltiply value of the current sensor 2 by"))
        self.id_tab.append(rct_id(
            0x02247588, 5, "battery_placeholder[0].cells_stat[2].u_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[2].u_min.value"))
        self.id_tab.append(rct_id(0x031A6110, 6, "energy.e_ext_month",
                           rct_data.t_float, "External month energy [Wh]"))
        self.id_tab.append(rct_id(
            0x035E64EA, 7, "battery_placeholder[0].module_sn[5]", rct_data.t_string, "Module 5 Serial Number"))
        ...
        self.id_tab.append(rct_id(
            0x03D9C51F, 10, "battery.cells_stat[0].u_max.value", rct_data.t_float, "battery.cells_stat[0].u_max.value"))
        self.id_tab.append(rct_id(0x040385DB, 11, "common_control_bits",
                           rct_data.t_uint32, "Bit coded functions"))
        self.id_tab.append(rct_id(
            0x048C9D69, 12, "battery_placeholder[0].cells_stat[1].u_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[1].u_min.value"))
        ...
        self.id_tab.append(rct_id(
            0x056162CA, 15, "battery.cells_stat[4].u_min.time", rct_data.t_uint32, "battery.cells_stat[4].u_min.time"))
        self.id_tab.append(rct_id(
            0x056417DF, 16, "battery.cells_stat[3].t_max.index", rct_data.t_uint8, "battery.cells_stat[3].t_max.index"))
        ...
        self.id_tab.append(rct_id(
            0x064A60FE, 19, "battery.cells_stat[4].t_max.index", rct_data.t_uint8, "battery.cells_stat[4].t_max.index"))
        ...
        self.id_tab.append(rct_id(
            0x071B5514, 23, "battery_placeholder[0].cells_stat[3].t_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[3].t_max.index"))
        self.id_tab.append(rct_id(0x07367B64, 24, "rb485.phase_marker",
                           rct_data.t_int16, "Next phase after phase 1 in Power Switch"))
        self.id_tab.append(rct_id(
            0x073C7E5D, 25, "battery_placeholder[0].max_cell_temperature", rct_data.t_float, "battery_placeholder[0].max_cell_temperature"))
        self.id_tab.append(rct_id(
            0x074B1EF5, 26, "battery_placeholder[0].cells_stat[3].u_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[3].u_max.index"))
        self.id_tab.append(rct_id(
            0x077692DE, 27, "battery.cells_stat[4].u_max.index", rct_data.t_uint8, "battery.cells_stat[4].u_max.index"))
        ...
        self.id_tab.append(rct_id(
            0x086C75B0, 30, "battery.stack_software_version[3]", rct_data.t_uint32, "Software version stack 3"))
        self.id_tab.append(rct_id(0x0875C906, 31, "hw_test.bt_time[2]",
                           rct_data.t_float, "hw_test.bt_time[2]"))
        self.id_tab.append(rct_id(
            0x08E81725, 32, "battery_placeholder[0].cells_stat[0].t_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[0].t_max.value"))
        self.id_tab.append(rct_id(0x095AFAA8, 33, "logger.minutes_ul3_log_ts",
                           rct_data.t_log_ts, "logger.minutes_ul3_log_ts"))
        self.id_tab.append(rct_id(
            0x09923C1E, 35, "battery.cells_stat[3].t_min.index", rct_data.t_uint8, "battery.cells_stat[3].t_min.index"))
        ...
        self.id_tab.append(rct_id(
            0x0B94A673, 39, "battery_placeholder[0].cells_stat[6].t_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[6].t_min.time"))
        self.id_tab.append(rct_id(0x0BA16A10, 40, "wifi.sockb_protocol",
                           rct_data.t_enum, "Network mode"))
        self.id_tab.append(rct_id(
            0x0C2A7286, 41, "battery_placeholder[0].cells_resist[0]", rct_data.t_string, "battery_placeholder[0].cells_resist[0]"))
        ...
        self.id_tab.append(rct_id(
            0x0CB5D21B, 44, "dc_conv.dc_conv_struct[1].p_dc_lp", rct_data.t_float, "Solar generator B power [W]"))
        ...
        self.id_tab.append(rct_id(
            0x0CFA8BC4, 47, "battery.stack_cycles[1]", rct_data.t_uint16, "battery.stack_cycles[1]"))
        self.id_tab.append(rct_id(0x0D658831, 48, "i_bottom_max",
                           rct_data.t_float, "i_bottom_max"))
        self.id_tab.append(
            rct_id(0x0DACF21B, 49, "battery.cells_stat[4]", rct_data.t_string, "battery.cells_stat[4]"))
        self.id_tab.append(rct_id(
            0x0DBD5E77, 50, "battery_placeholder[0].cells_stat[6].u_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[6].u_min.index"))
        ...
        self.id_tab.append(rct_id(
            0x0E4AA301, 55, "battery_placeholder[0].cells_stat[6].u_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[6].u_max.index"))
        self.id_tab.append(
            rct_id(0x0E799A56, 56, "io_board.rse_table[0]", rct_data.t_float, "K4..K1: 0000"))
        self.id_tab.append(rct_id(
            0x0EC64BA7, 57, "battery_placeholder[0].stack_software_version[3]", rct_data.t_uint32, "Software version stack 3"))
        self.id_tab.append(rct_id(
            0x0EF60C7E, 58, "battery.cells_stat[3].u_max.value", rct_data.t_float, "battery.cells_stat[3].u_max.value"))
        ...
        self.id_tab.append(rct_id(
            0x1025B491, 62, "battery_placeholder[0].maximum_discharge_current", rct_data.t_float, "Max. discharge current [A]"))
        ...
        self.id_tab.append(rct_id(
            0x120EC3B4, 68, "battery.cells_stat[4].u_min.index", rct_data.t_uint8, "battery.cells_stat[4].u_min.index"))
        ...
        self.id_tab.append(
            rct_id(0x15AB1A61, 75, "power_mng.schedule[2]", rct_data.t_string, "power_mng.schedule[2]"))
        self.id_tab.append(rct_id(0x162491E8, 76, "battery.module_sn[5]",
                           rct_data.t_string, "Module 5 Serial Number"))
        self.id_tab.append(rct_id(
            0x1639B2D8, 77, "battery_placeholder[0].cells_stat[4].u_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[4].u_max.index"))
        ...
        self.id_tab.append(
            rct_id(0x1781CD31, 83, "battery_placeholder[0].soh", rct_data.t_float, "SOH (State of Health)"))
        self.id_tab.append(rct_id(0x17E3AF97, 84, "db.power_board.adc_p9V_meas",
                           rct_data.t_float, "db.power_board.adc_p9V_meas"))
        self.id_tab.append(rct_id(
            0x18469762, 85, "battery_placeholder[0].cells_stat[0].u_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[0].u_max.value"))
        self.id_tab.append(rct_id(
            0x18BD807D, 86, "battery_placeholder[0].cells_stat[4].t_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[4].t_min.index"))
        self.id_tab.append(rct_id(
            0x18D1E9E0, 87, "battery.cells_stat[5].u_max.index", rct_data.t_uint8, "battery.cells_stat[5].u_max.index"))
        self.id_tab.append(rct_id(
            0x18F98B6D, 88, "battery.cells_stat[3].u_min.value", rct_data.t_float, "battery.cells_stat[3].u_min.value"))
        ...
        self.id_tab.append(rct_id(
            0x1D83D2A5, 100, "battery_placeholder[0].cells[4]", rct_data.t_string, "battery_placeholder[0].cells[4]"))
        self.id_tab.append(rct_id(
            0x1E0EB397, 101, "battery_placeholder[0].cells_stat[6].u_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[6].u_max.value"))
        self.id_tab.append(rct_id(0x1E5FCA70, 102, "battery.maximum_charge_current",
                           rct_data.t_float, "Max. charge current [A]"))
        self.id_tab.append(rct_id(
            0x1F44C23A, 103, "battery_placeholder[0].cells_stat[1].t_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[1].t_min.index"))
        self.id_tab.append(rct_id(
            0x1F73B6A4, 104, "battery.cells_stat[3].t_max.time", rct_data.t_uint32, "battery.cells_stat[3].t_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x1FA192E3, 106, "battery_placeholder[0].cells_resist[4]", rct_data.t_string, "battery_placeholder[0].cells_resist[4]"))
        self.id_tab.append(rct_id(
            0x1FB3A602, 107, "battery_placeholder[0].cells_stat[2].t_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[2].t_max.value"))
        ...
        self.id_tab.append(rct_id(
            0x20A3A91F, 110, "battery_placeholder[0].module_sn[4]", rct_data.t_string, "Module 4 Serial Number"))
        ...
        self.id_tab.append(rct_id(0x21961B58, 113, "battery.current",
                           rct_data.t_float, "Battery current [A]"))
        self.id_tab.append(rct_id(
            0x21E1A802, 114, "energy.e_dc_month_sum[1]", rct_data.t_float, "energy.e_dc_month_sum[1]"))
        self.id_tab.append(rct_id(0x21EE7CBB, 115, "rb485.u_l_grid[2]",
                           rct_data.t_float, "Grid phase 3 voltage [V]"))
        self.id_tab.append(rct_id(0x2266DCB8, 116, "flash_rtc.rtc_mcc_quartz_max_diff", rct_data.t_float,
                           "Maximum allowed quartz frequency difference between RTC and Microcontroller [ppm]"))
        self.id_tab.append(
            rct_id(0x226A23A4, 117, "dc_conv.dc_conv_struct[0].u_target", rct_data.t_float, "MPP on input A [V]"))
        self.id_tab.append(rct_id(
            0x2295401F, 118, "battery_placeholder[0].cells_stat[3].u_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[3].u_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x235E0DF5, 122, "battery_placeholder[0].stack_software_version[1]", rct_data.t_uint32, "Software version stack 1"))
        self.id_tab.append(rct_id(0x236D2178, 123, "frt.t_min[1]",
                           rct_data.t_float, "Point 2 time [s]"))
        self.id_tab.append(rct_id(
            0x23D4A386, 124, "battery_placeholder[0].cells_stat[0]", rct_data.t_string, "battery_placeholder[0].cells_stat[0]"))
        self.id_tab.append(
            rct_id(0x23E55DA0, 125, "battery.cells_stat[5]", rct_data.t_string, "battery.cells_stat[5]"))
        ...
        self.id_tab.append(rct_id(
            0x241CFA0A, 128, "battery_placeholder[0].min_cell_temperature", rct_data.t_float, "battery_placeholder[0].min_cell_temperature"))
        self.id_tab.append(rct_id(
            0x241F1F98, 129, "energy.e_dc_day_sum[1]", rct_data.t_float, "energy.e_dc_day_sum[1]"))
        self.id_tab.append(rct_id(
            0x24AC4CBB, 130, "battery_placeholder[0].cells_resist[6]", rct_data.t_string, "battery_placeholder[0].cells_resist[6]"))
        self.id_tab.append(rct_id(0x2545E22D, 131, "g_sync.u_l_rms[2]",
                           rct_data.t_float, "AC voltage phase 3 [V]"))
        self.id_tab.append(rct_id(
            0x257B5945, 132, "battery.cells_stat[2].u_min.index", rct_data.t_uint8, "battery.cells_stat[2].u_min.index"))
        ...
        self.id_tab.append(rct_id(
            0x26363AAE, 135, "battery.cells_stat[1].t_max.index", rct_data.t_uint8, "battery.cells_stat[1].t_max.index"))
        self.id_tab.append(rct_id(
            0x265EACF6, 136, "battery.cells_stat[2].t_max.time", rct_data.t_uint32, "battery.cells_stat[2].t_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x27116260, 139, "battery_placeholder[0].cells_stat[5].u_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[5].u_min.value"))
        ...
        self.id_tab.append(rct_id(
            0x27C39CEA, 143, "battery.stack_cycles[6]", rct_data.t_uint16, "battery.stack_cycles[6]"))
        ...
        self.id_tab.append(
            rct_id(0x29CA60F8, 148, "io_board.rse_table[10]", rct_data.t_float, "K4..K1: 1010"))
        self.id_tab.append(rct_id(
            0x2A30A97E, 149, "battery.stack_cycles[5]", rct_data.t_uint16, "battery.stack_cycles[5]"))
        ...
        self.id_tab.append(rct_id(
            0x2E9F3C50, 156, "battery_placeholder[0].cells_stat[0].t_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[0].t_max.index"))
        self.id_tab.append(rct_id(0x2ED89924, 157, "db.power_board.afi_t300",
                           rct_data.t_float, "AFI 300 mA switching off time [s]"))
        self.id_tab.append(rct_id(
            0x2ED8A639, 158, "battery_placeholder[0].cells_stat[2].u_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[2].u_min.time"))
        ...
        self.id_tab.append(rct_id(
            0x2F84A0A9, 161, "battery_placeholder[0].cells[2]", rct_data.t_string, "battery_placeholder[0].cells[2]"))
        self.id_tab.append(rct_id(0x3044195F, 162, "grid_mon[1].u_under.time",
                           rct_data.t_float, "Min. voltage switch-off time level 2 [s]"))
        self.id_tab.append(rct_id(
            0x31413485, 163, "battery_placeholder[0].cells_stat[5].u_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[5].u_min.index"))
        self.id_tab.append(rct_id(
            0x314C13EB, 164, "battery_placeholder[0].cells_stat[5].u_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[5].u_max.value"))
        ...
        self.id_tab.append(rct_id(
            0x331D0689, 169, "battery.cells_stat[2].t_max.value", rct_data.t_float, "battery.cells_stat[2].t_max.value"))
        self.id_tab.append(rct_id(
            0x336415EA, 170, "battery.cells_stat[0].t_max.time", rct_data.t_uint32, "battery.cells_stat[0].t_max.time"))
        ...
        self.id_tab.append(rct_id(0x33F76B78, 172, "nsm.p_u[0][1]",
                           rct_data.t_float, "Point 1 voltage [V]"))
        self.id_tab.append(
            rct_id(0x34A164E7, 173, "battery.cells_stat[0]", rct_data.t_string, "battery.cells_stat[0]"))
        self.id_tab.append(rct_id(
            0x34E33726, 174, "battery.cells_stat[2].u_max.index", rct_data.t_uint8, "battery.cells_stat[2].u_max.index"))
        ...
        self.id_tab.append(rct_id(
            0x3503B92D, 177, "battery.cells_stat[3].u_max.time", rct_data.t_uint32, "battery.cells_stat[3].u_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x374B5DD6, 185, "battery_placeholder[0].cells_stat[6].u_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[6].u_min.time"))
        ...
        self.id_tab.append(rct_id(0x38789061, 189, "nsm.f_low_rise_grad_storage",
                           rct_data.t_float, "Power rise gradient for P(f) under-frequency mode with battery [1/Pn*Hz]"))
        ...
        self.id_tab.append(rct_id(
            0x39AD4639, 193, "battery_placeholder[0].cells_stat[5].u_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[5].u_min.time"))
        ...
        self.id_tab.append(rct_id(
            0x3A35D491, 196, "battery_placeholder[0].cells_stat[2].u_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[2].u_max.value"))
        self.id_tab.append(rct_id(0x3A444FC6, 197, "g_sync.s_ac_lp[0]",
                           rct_data.t_float, "Apparent power phase 1 [VA]"))
        self.id_tab.append(rct_id(
            0x3A7D5F53, 198, "battery.cells_stat[1].u_max.value", rct_data.t_float, "battery.cells_stat[1].u_max.value"))
        ...
        self.id_tab.append(rct_id(
            0x3BA1B77B, 206, "battery.cells_stat[3].t_min.value", rct_data.t_float, "battery.cells_stat[3].t_min.value"))
        self.id_tab.append(rct_id(0x3C24F3E8, 207, "inv_struct.cosinus_phi",
                           rct_data.t_float, "cos 􀳦"))
        self.id_tab.append(
            rct_id(0x3C705F61, 208, "io_board.rse_table[8]", rct_data.t_float, "K4..K1: 1000"))
        ...
        self.id_tab.append(
            rct_id(0x3DBCC6B4, 213, "io_board.rse_table[6]", rct_data.t_float, "K4..K1: 0110"))
        ...
        self.id_tab.append(rct_id(
            0x3F98F58A, 218, "battery.cells_stat[5].t_max.index", rct_data.t_uint8, "battery.cells_stat[5].t_max.index"))
        ...
        self.id_tab.append(
            rct_id(0x40B07CA4, 221, "power_mng.schedule[6]", rct_data.t_string, "power_mng.schedule[6]"))
        ...
        self.id_tab.append(rct_id(0x41744E11, 223, "frt.u_min[0]",
                           rct_data.t_float, "Point 1 voltage [V]"))
        self.id_tab.append(rct_id(
            0x41B11ECF, 224, "battery.cells_stat[3].u_min.index", rct_data.t_uint8, "battery.cells_stat[3].u_min.index"))
        self.id_tab.append(rct_id(
            0x428CCF46, 225, "battery.cells_stat[5].u_min.value", rct_data.t_float, "battery.cells_stat[5].u_min.value"))
        ...
        self.id_tab.append(rct_id(
            0x442A3409, 233, "battery.cells_stat[4].t_min.time", rct_data.t_uint32, "battery.cells_stat[4].t_min.time"))
        self.id_tab.append(rct_id(
            0x4443C661, 234, "battery.cells_stat[0].t_max.index", rct_data.t_uint8, "battery.cells_stat[0].t_max.index"))
        self.id_tab.append(rct_id(0x44D4C533, 235, "energy.e_grid_feed_total",
                           rct_data.t_float, "Total energy grid feed-in [Wh]"))
        self.id_tab.append(rct_id(
            0x4539A6D4, 236, "can_bus.bms_update_response[0]", rct_data.t_uint32, "can_bus.bms_update_response[0]"))
        self.id_tab.append(rct_id(
            0x465DDB50, 237, "battery_placeholder[0].cells_stat[2].t_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[2].t_min.value"))
        self.id_tab.append(rct_id(0x46635546, 238, "net.n_descendants",
                           rct_data.t_int8, "Number of descendant slaves"))
        self.id_tab.append(rct_id(
            0x4686E044, 239, "battery_placeholder[0].cells_stat[1].u_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[1].u_min.index"))
        self.id_tab.append(rct_id(0x46892579, 240, "flash_param.write_cycles",
                           rct_data.t_uint32, "Write cycles of flash parameters"))
        self.id_tab.append(rct_id(
            0x46C3625D, 241, "battery_placeholder[0].cells_stat[2]", rct_data.t_string, "battery_placeholder[0].cells_stat[2]"))
        self.id_tab.append(rct_id(0x474F80D5, 242, "iso_struct.Rn",
                           rct_data.t_float, "Insulation resistance on negative DC input [Ohm]"))
        self.id_tab.append(rct_id(
            0x4764F9EE, 243, "battery_placeholder[0].cells_stat[3].t_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[3].t_max.value"))
        self.id_tab.append(
            rct_id(0x47A1DACA, 244, "power_mng.schedule[8]", rct_data.t_string, "power_mng.schedule[8]"))
        ...
        self.id_tab.append(rct_id(
            0x495BF0B6, 249, "energy.e_dc_year_sum[0]", rct_data.t_float, "energy.e_dc_year_sum[0]"))
        ...
        self.id_tab.append(rct_id(
            0x4AAEB0D2, 252, "battery_placeholder[0].cells_stat[1]", rct_data.t_string, "battery_placeholder[0].cells_stat[1]"))
        self.id_tab.append(rct_id(
            0x4AE96C12, 253, "dc_conv.dc_conv_struct[1].mpp.mpp_step", rct_data.t_float, "MPP search step on input B [V]"))
        ...
        self.id_tab.append(rct_id(
            0x4D684EF2, 262, "battery_placeholder[0].cells[0]", rct_data.t_string, "battery_placeholder[0].cells[0]"))
        self.id_tab.append(rct_id(
            0x4D985F33, 263, "battery.cells_stat[5].u_max.value", rct_data.t_float, "battery.cells_stat[5].u_max.value"))
        self.id_tab.append(rct_id(0x4DB1B91E, 264, "switch_on_cond.f_max",
                           rct_data.t_float, "Max. frequency"))
        self.id_tab.append(rct_id(
            0x4DC372A0, 265, "battery_placeholder[0].cells_stat[4].u_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[4].u_max.value"))
        ...
        self.id_tab.append(rct_id(
            0x4FC53F19, 277, "battery_placeholder[0].module_sn[3]", rct_data.t_string, "Module 3 Serial Number"))
        self.id_tab.append(rct_id(
            0x4FEDC1BE, 278, "battery_placeholder[0].cells_stat[5].t_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[5].t_min.value"))
        self.id_tab.append(rct_id(
            0x4FF8CCE2, 279, "battery_placeholder[0].stack_software_version[5]", rct_data.t_uint32, "Software version stack 5"))
        self.id_tab.append(rct_id(
            0x501A162D, 280, "battery.cells_resist[5]", rct_data.t_dump, "battery.cells_resist[5]"))
        self.id_tab.append(rct_id(
            0x50514732, 281, "battery.cells_stat[6].u_min.index", rct_data.t_uint8, "battery.cells_stat[6].u_min.index"))
        ...
        self.id_tab.append(rct_id(
            0x518C7BBE, 285, "battery.cells_stat[5].u_min.time", rct_data.t_uint32, "battery.cells_stat[5].u_min.time"))
        self.id_tab.append(rct_id(
            0x51E5377D, 286, "battery_placeholder[0].stack_cycles[1]", rct_data.t_uint16, "battery_placeholder[0].stack_cycles[1]"))
        self.id_tab.append(rct_id(0x5293B668, 287, "logger.minutes_soc_log_ts",
                           rct_data.t_log_ts, "logger.minutes_soc_log_ts"))
        self.id_tab.append(rct_id(
            0x53656F42, 288, "battery_placeholder[0].cells_stat[2].u_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[2].u_max.index"))
        self.id_tab.append(rct_id(
            0x537C719F, 289, "battery.cells_stat[0].t_max.value", rct_data.t_float, "battery.cells_stat[0].t_max.value"))
        ...
        self.id_tab.append(
            rct_id(0x54DBC202, 296, "io_board.rse_table[12]", rct_data.t_float, "K4..K1: 1100"))
        ...
        self.id_tab.append(rct_id(
            0x576D2A08, 303, "battery_placeholder[0].cells_stat[3].t_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[3].t_min.time"))
        self.id_tab.append(rct_id(
            0x57945EE4, 304, "battery_placeholder[0].maximum_charge_current", rct_data.t_float, "Max. charge current [A]"))
        ...
        self.id_tab.append(
            rct_id(0x5867B3BE, 307, "io_board.rse_table[2]", rct_data.t_float, "K4..K1: 0010"))
        self.id_tab.append(rct_id(0x58C1A946, 308, "io_board.check_state",
                           rct_data.t_uint8, "io_board.check_state"))
        self.id_tab.append(
            rct_id(0x592B13DF, 309, "power_mng.schedule[4]", rct_data.t_string, "power_mng.schedule[4]"))
        ...
        self.id_tab.append(rct_id(
            0x5A120CE4, 313, "battery.cells_stat[1].t_max.time", rct_data.t_uint32, "battery.cells_stat[1].t_max.time"))
        self.id_tab.append(rct_id(0x5A316247, 314, "wifi.mode",
                           rct_data.t_string, "WiFi mode"))
        self.id_tab.append(rct_id(
            0x5A9EEFF0, 315, "battery.stack_cycles[4]", rct_data.t_uint16, "battery.stack_cycles[4]"))
        self.id_tab.append(rct_id(
            0x5AF50FD7, 316, "battery.cells_stat[4].t_min.value", rct_data.t_float, "battery.cells_stat[4].t_min.value"))
        self.id_tab.append(rct_id(0x5B10CE81, 317, "power_mng.is_heiphoss",
                           rct_data.t_uint8, "HeiPhoss mode"))
        self.id_tab.append(rct_id(
            0x5BA122A5, 318, "battery.stack_cycles[2]", rct_data.t_uint16, "battery.stack_cycles[2]"))
        self.id_tab.append(rct_id(
            0x5BB8075A, 319, "dc_conv.dc_conv_struct[1].u_sg_lp", rct_data.t_float, "Solar generator B voltage [V]"))
        ...
        self.id_tab.append(
            rct_id(0x5C93093B, 321, "battery_placeholder[0].status2", rct_data.t_int32, "Battery extra status"))
        ...
        self.id_tab.append(rct_id(
            0x5E942C62, 327, "dc_conv.dc_conv_struct[1].mpp.fixed_voltage", rct_data.t_float, "Fixed voltage Solar generator B [V]"))
        self.id_tab.append(rct_id(0x5EE03C45, 328, "io_board.alarm_home_relay_mode",
                           rct_data.t_enum, "Multifunctional relay usage"))
        self.id_tab.append(rct_id(
            0x5EF54372, 329, "battery_placeholder[0].cells_stat[0].u_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[0].u_max.index"))
        ...
        self.id_tab.append(rct_id(
            0x60435F1C, 332, "battery_placeholder[0].cells[6]", rct_data.t_string, "battery_placeholder[0].cells[6]"))
        self.id_tab.append(rct_id(
            0x60749E5E, 333, "battery.cells_stat[6].u_min.time", rct_data.t_uint32, "battery.cells_stat[6].u_min.time"))
        ...
        self.id_tab.append(rct_id(0x612F7EAB, 335, "g_sync.s_ac[1]",
                           rct_data.t_float, "Apparent power phase 2 [VA]"))
        self.id_tab.append(rct_id(
            0x61EAC702, 336, "battery.cells_stat[0].t_min.value", rct_data.t_float, "battery.cells_stat[0].t_min.value"))
        self.id_tab.append(rct_id(
            0x6213589B, 337, "battery.cells_stat[6].u_min.value", rct_data.t_float, "battery.cells_stat[6].u_min.value"))
        ...
        self.id_tab.append(rct_id(
            0x6383DEA9, 343, "battery_placeholder[0].cells_stat[1].t_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[1].t_max.value"))
        self.id_tab.append(rct_id(
            0x6388556C, 344, "battery.stack_software_version[0]", rct_data.t_uint32, "Software version stack 0"))
        self.id_tab.append(rct_id(
            0x6445D856, 345, "battery.cells_stat[1].u_min.index", rct_data.t_uint8, "battery.cells_stat[1].u_min.index"))
        ...
        self.id_tab.append(rct_id(
            0x649B10DA, 347, "battery.cells_resist[0]", rct_data.t_dump, "battery.cells_resist[0]"))
        self.id_tab.append(rct_id(0x650C1ED7, 348, "g_sync.i_dr_eff[1]",
                           rct_data.t_float, "Current phase 2 [A]"))
        self.id_tab.append(rct_id(
            0x652B7536, 349, "battery_placeholder[0].cells_stat[3].t_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[3].t_min.index"))
        self.id_tab.append(
            rct_id(0x6599E3D3, 350, "power_mng.schedule[3]", rct_data.t_string, "power_mng.schedule[3]"))
        ...
        self.id_tab.append(
            rct_id(0x664A1326, 355, "io_board.rse_table[14]", rct_data.t_float, "K4..K1: 1110"))
        ...
        self.id_tab.append(rct_id(
            0x6743CCCE, 359, "battery_placeholder[0].cells_stat[6].t_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[6].t_max.index"))
        self.id_tab.append(
            rct_id(0x675776B1, 360, "dc_conv.dc_conv_struct[1].u_target", rct_data.t_float, "MPP on input B [V]"))
        ...
        self.id_tab.append(
            rct_id(0x6830F6E4, 364, "io_board.rse_table[9]", rct_data.t_float, "K4..K1: 1001"))
        ...
        self.id_tab.append(rct_id(
            0x690C32D2, 368, "battery_placeholder[0].module_sn[0]", rct_data.t_string, "Module 0 Serial Number"))
        self.id_tab.append(rct_id(
            0x6974798A, 369, "battery.stack_software_version[6]", rct_data.t_uint32, "Software version stack 6"))
        ...
        self.id_tab.append(rct_id(
            0x6C03F5ED, 376, "battery_placeholder[0].bms_power_version", rct_data.t_uint32, "Software version BMS Power"))
        self.id_tab.append(rct_id(
            0x6C10E96A, 377, "battery_placeholder[0].cells_stat[0].u_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[0].u_min.time"))
        self.id_tab.append(rct_id(0x6C243F71, 378, "modbus.address",
                           rct_data.t_uint8, "RS485 address"))
        self.id_tab.append(
            rct_id(0x6C2D00E4, 379, "io_board.rse_table[1]", rct_data.t_float, "K4..K1: 0001"))
        self.id_tab.append(rct_id(0x6C44F721, 380, "i_dc_max",
                           rct_data.t_float, "Max. DC-component of Iac [A]"))
        self.id_tab.append(rct_id(
            0x6CFCD774, 381, "energy.e_dc_year_sum[1]", rct_data.t_float, "energy.e_dc_year_sum[1]"))
        self.id_tab.append(rct_id(0x6D5318C8, 382, "cs_map[1]",
                           rct_data.t_uint8, "Associate current sensor 1 with phase L"))
        self.id_tab.append(rct_id(
            0x6D639C25, 383, "battery_placeholder[0].cells_stat[0].t_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[0].t_min.value"))
        self.id_tab.append(rct_id(0x6D7C0BF4, 384, "wifi.sockb_port",
                           rct_data.t_int32, "Port"))
        self.id_tab.append(rct_id(
            0x6DB1FDDC, 385, "battery.cells_stat[4].u_min.value", rct_data.t_float, "battery.cells_stat[4].u_min.value"))
        ...
        self.id_tab.append(rct_id(
            0x6E24632E, 388, "battery.cells_stat[5].u_max.time", rct_data.t_uint32, "battery.cells_stat[5].u_max.time"))
        self.id_tab.append(rct_id(
            0x6E3336A8, 389, "battery_placeholder[0].cells_stat[5].t_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[5].t_max.index"))
        ...
        self.id_tab.append(rct_id(
            0x701A0482, 395, "dc_conv.dc_conv_struct[0].enabled", rct_data.t_bool, "Solar generator A connected"))
        self.id_tab.append(rct_id(
            0x70349444, 396, "battery.cells_stat[1].t_min.index", rct_data.t_uint8, "battery.cells_stat[1].t_min.index"))
        ...
        self.id_tab.append(rct_id(
            0x71196579, 400, "battery.cells_stat[5].t_min.index", rct_data.t_uint8, "battery.cells_stat[5].t_min.index"))
        ...
        self.id_tab.append(rct_id(
            0x71CB0B57, 406, "battery.cells_resist[1]", rct_data.t_dump, "battery.cells_resist[1]"))
        ...
        self.id_tab.append(
            rct_id(0x74FD4609, 415, "battery.cells_stat[2]", rct_data.t_string, "battery.cells_stat[2]"))
        ...
        self.id_tab.append(rct_id(
            0x75898A45, 417, "battery_placeholder[0].cells_stat[5].t_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[5].t_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x770A6E7C, 422, "battery.cells_stat[0].u_max.index", rct_data.t_uint8, "battery.cells_stat[0].u_max.index"))
        self.id_tab.append(rct_id(0x777DC0EB, 423, "iso_struct.r_min",
                           rct_data.t_float, "Minimum allowed insulation resistance [Ohm]"))
        self.id_tab.append(rct_id(
            0x77A9480F, 424, "battery_placeholder[0].minimum_discharge_voltage", rct_data.t_float, "Min. discharge voltage [V]"))
        self.id_tab.append(rct_id(0x77DD4364, 425, "hw_test.bt_time[5]",
                           rct_data.t_float, "hw_test.bt_time[5]"))
        self.id_tab.append(rct_id(
            0x77E5CEF1, 426, "battery_placeholder[0].stack_software_version[0]", rct_data.t_uint32, "Software version stack 0"))
        self.id_tab.append(rct_id(
            0x78228507, 427, "battery_placeholder[0].stack_cycles[6]", rct_data.t_uint16, "battery_placeholder[0].stack_cycles[6]"))
        self.id_tab.append(rct_id(
            0x7839EBCB, 428, "battery_placeholder[0].cells_stat[3].u_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[3].u_min.time"))
        self.id_tab.append(rct_id(0x7924ABD9, 429, "inverter_sn",
                           rct_data.t_string, "Serial number"))
        self.id_tab.append(rct_id(
            0x792897C9, 430, "battery_placeholder[0].cells_stat[4].t_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[4].t_min.time"))
        ...
        self.id_tab.append(
            rct_id(0x79D7D617, 435, "battery_placeholder[0].current", rct_data.t_float, "Battery current [A]"))
        self.id_tab.append(rct_id(
            0x79E66CDF, 436, "battery_placeholder[0].cells_stat[6].t_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[6].t_min.index"))
        self.id_tab.append(rct_id(0x7A5C91F8, 437, "nsm.p_u[1][0]",
                           rct_data.t_float, "Point 2 P/Pn"))
        self.id_tab.append(rct_id(
            0x7A67E33B, 438, "can_bus.bms_update_response[1]", rct_data.t_uint32, "can_bus.bms_update_response[1]"))
        ...
        self.id_tab.append(
            rct_id(0x7AF0AD03, 442, "power_mng.schedule[9]", rct_data.t_string, "power_mng.schedule[9]"))
        ...
        self.id_tab.append(rct_id(
            0x7B8E811E, 445, "battery_placeholder[0].cells_stat[6]", rct_data.t_string, "battery_placeholder[0].cells_stat[6]"))
        self.id_tab.append(rct_id(
            0x7BF3886B, 446, "battery_placeholder[0].stack_cycles[2]", rct_data.t_uint16, "battery_placeholder[0].stack_cycles[2]"))
        ...
        self.id_tab.append(rct_id(
            0x7C863EDB, 450, "battery_placeholder[0].cells[3]", rct_data.t_string, "battery_placeholder[0].cells[3]"))
        self.id_tab.append(rct_id(
            0x7D839AE6, 451, "battery_placeholder[0].cells_resist[2]", rct_data.t_string, "battery_placeholder[0].cells_resist[2]"))
        ...
        self.id_tab.append(rct_id(
            0x7E590128, 455, "battery.cells_stat[0].u_max.time", rct_data.t_uint32, "battery.cells_stat[0].u_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x7F42BB82, 457, "battery.cells_stat[6].u_max.index", rct_data.t_uint8, "battery.cells_stat[6].u_max.index"))
        self.id_tab.append(rct_id(0x7F813D73, 458, "fault[3].flt",
                           rct_data.t_uint32, "Error bit field 4"))
        self.id_tab.append(rct_id(
            0x7FF6252C, 459, "battery.cells_stat[5].t_max.time", rct_data.t_uint32, "battery.cells_stat[5].t_max.time"))
        self.id_tab.append(rct_id(
            0x804A3266, 460, "battery.cells_stat[6].u_max.value", rct_data.t_float, "battery.cells_stat[6].u_max.value"))
        self.id_tab.append(rct_id(0x80835476, 461, "db.power_board.adc_p5V_W_meas",
                           rct_data.t_float, "db.power_board.adc_p5V_W_meas"))
        self.id_tab.append(rct_id(
            0x8128228D, 462, "battery_placeholder[0].cells_stat[1].u_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[1].u_max.value"))
        self.id_tab.append(rct_id(
            0x812E5ADD, 463, "energy.e_dc_total_sum[1]", rct_data.t_float, "energy.e_dc_total_sum[1]"))
        self.id_tab.append(rct_id(
            0x8160539D, 464, "battery.cells_stat[4].t_max.value", rct_data.t_float, "battery.cells_stat[4].t_max.value"))
        ...
        self.id_tab.append(rct_id(
            0x8352F9DD, 471, "battery_placeholder[0].cells_stat[4].t_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[4].t_min.value"))
        ...
        self.id_tab.append(rct_id(
            0x8594D11E, 476, "battery_placeholder[0].module_sn[6]", rct_data.t_string, "Module 6 Serial Number"))
        ...
        self.id_tab.append(rct_id(
            0x8822EF35, 481, "battery_placeholder[0].stack_software_version[2]", rct_data.t_uint32, "Software version stack 2"))
        self.id_tab.append(rct_id(0x883DE9AB, 482, "g_sync.s_ac_lp[2]",
                           rct_data.t_float, "Apparent power phase 3 [VA]"))
        self.id_tab.append(rct_id(
            0x885BB57E, 483, "battery.cells_stat[6].t_min.value", rct_data.t_float, "battery.cells_stat[6].t_min.value"))
        self.id_tab.append(rct_id(0x887D43C4, 484, "g_sync.i_dr_lp[0]",
                           rct_data.t_float, "Current phase 1 (average) [A]"))
        self.id_tab.append(rct_id(
            0x889DC27F, 485, "battery.cells_stat[0].u_min.value", rct_data.t_float, "battery.cells_stat[0].u_min.value"))
        self.id_tab.append(rct_id(
            0x88BBF8CB, 486, "battery.cells_stat[5].t_min.value", rct_data.t_float, "battery.cells_stat[5].t_min.value"))
        self.id_tab.append(
            rct_id(0x88C9707B, 487, "io_board.rse_table[15]", rct_data.t_float, "K4..K1: 1111"))
        ...
        self.id_tab.append(rct_id(
            0x89B25F4B, 492, "battery.stack_cycles[3]", rct_data.t_uint16, "battery.stack_cycles[3]"))
        ...
        self.id_tab.append(rct_id(
            0x8AFD1410, 495, "battery_placeholder[0].stack_cycles[4]", rct_data.t_uint16, "battery_placeholder[0].stack_cycles[4]"))
        self.id_tab.append(
            rct_id(0x8B4BE168, 496, "battery_placeholder[0].soc", rct_data.t_float, "SOC (State of charge)"))
        self.id_tab.append(rct_id(0x8B9FF008, 497, "battery.soc_target",
                           rct_data.t_float, "Target SOC"))
        self.id_tab.append(rct_id(
            0x8BB08839, 498, "battery.cells_stat[6].t_min.time", rct_data.t_uint32, "battery.cells_stat[6].t_min.time"))
        self.id_tab.append(rct_id(
            0x8C6E28E4, 499, "battery_placeholder[0].cells_stat[2].t_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[2].t_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x8DFFDD33, 504, "battery.cells_stat[3].u_min.time", rct_data.t_uint32, "battery.cells_stat[3].u_min.time"))
        ...
        self.id_tab.append(rct_id(
            0x8EC23427, 507, "battery.cells_stat[4].u_max.time", rct_data.t_uint32, "battery.cells_stat[4].u_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x8EF9C9B8, 510, "battery.cells_stat[6].t_max.time", rct_data.t_uint32, "battery.cells_stat[6].t_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x90832471, 518, "battery.cells_stat[1].u_max.time", rct_data.t_uint32, "battery.cells_stat[1].u_max.time"))
        self.id_tab.append(rct_id(
            0x9095FD74, 519, "battery_placeholder[0].cells[5]", rct_data.t_string, "battery_placeholder[0].cells[5]"))
        ...
        self.id_tab.append(rct_id(
            0x90C2AC13, 521, "battery_placeholder[0].stack_cycles[3]", rct_data.t_uint16, "battery_placeholder[0].stack_cycles[3]"))
        ...
        self.id_tab.append(rct_id(
            0x91C325D9, 526, "battery.cells_stat[0].t_min.time", rct_data.t_uint32, "battery.cells_stat[0].t_min.time"))
        self.id_tab.append(rct_id(
            0x91FB68CD, 527, "battery.cells_stat[6].t_max.value", rct_data.t_float, "battery.cells_stat[6].t_max.value"))
        self.id_tab.append(rct_id(
            0x920AFF34, 528, "battery_placeholder[0].cells_stat[1].t_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[1].t_max.index"))
        ...
        self.id_tab.append(rct_id(
            0x947DDC38, 542, "battery_placeholder[0].cells_stat[0].t_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[0].t_min.index"))
        self.id_tab.append(rct_id(
            0x9486134F, 543, "battery_placeholder[0].cells_stat[1].t_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[1].t_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x95E1E844, 546, "battery_placeholder[0].cells_stat[2].t_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[2].t_min.time"))
        self.id_tab.append(rct_id(
            0x961C8261, 547, "battery_placeholder[0].cells_stat[4].u_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[4].u_max.time"))
        ...
        self.id_tab.append(rct_id(
            0x97DC2ECB, 553, "battery_placeholder[0].cells[1]", rct_data.t_string, "battery_placeholder[0].cells[1]"))
        ...
        self.id_tab.append(rct_id(
            0x980C5525, 556, "battery_placeholder[0].max_cell_voltage", rct_data.t_float, "battery_placeholder[0].max_cell_voltage"))
        self.id_tab.append(
            rct_id(0x98ACC1B8, 557, "io_board.rse_table[4]", rct_data.t_float, "K4..K1: 0100"))
        self.id_tab.append(rct_id(0x99396810, 558, "battery.module_sn[1]",
                           rct_data.t_string, "Module 1 Serial Number"))
        self.id_tab.append(rct_id(
            0x993C06F6, 559, "battery.cells_resist[3]", rct_data.t_dump, "battery.cells_resist[3]"))
        ...
        self.id_tab.append(
            rct_id(0x9A33F9B7, 562, "power_mng.schedule[5]", rct_data.t_string, "power_mng.schedule[5]"))
        ...
        self.id_tab.append(rct_id(
            0x9AAA9CAA, 565, "battery_placeholder[0].stack_cycles[5]", rct_data.t_uint16, "battery_placeholder[0].stack_cycles[5]"))
        self.id_tab.append(
            rct_id(0x9B92023F, 566, "io_board.rse_table[7]", rct_data.t_float, "K4..K1: 0111"))
        ...
        self.id_tab.append(rct_id(
            0x9E1A88F5, 571, "dc_conv.dc_conv_struct[0].mpp.fixed_voltage", rct_data.t_float, "Fixed voltage Solar generator A [V]"))
        self.id_tab.append(rct_id(
            0x9E314430, 572, "battery.cells_stat[2].u_max.time", rct_data.t_uint32, "battery.cells_stat[2].u_max.time"))
        ...
        self.id_tab.append(rct_id(
            0xA23FE8B9, 579, "battery_placeholder[0].cells_stat[6].t_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[6].t_min.value"))
        self.id_tab.append(rct_id(
            0xA2F87161, 580, "battery_placeholder[0].cells_stat[0].u_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[0].u_max.time"))
        ...
        self.id_tab.append(rct_id(
            0xA3E48B21, 584, "battery.cells_stat[2].t_min.value", rct_data.t_float, "battery.cells_stat[2].t_min.value"))
        self.id_tab.append(rct_id(
            0xA40906BF, 585, "battery.stack_software_version[4]", rct_data.t_uint32, "Software version stack 4"))
        ...
        self.id_tab.append(rct_id(
            0xA54C4685, 588, "battery.stack_software_version[1]", rct_data.t_uint32, "Software version stack 1"))
        ...
        self.id_tab.append(rct_id(
            0xA6871A4D, 593, "battery.cells_stat[4].t_min.index", rct_data.t_uint8, "battery.cells_stat[4].t_min.index"))
        self.id_tab.append(rct_id(
            0xA6C4FD4A, 594, "battery.stack_cycles[0]", rct_data.t_uint16, "battery.stack_cycles[0]"))
        ...
        self.id_tab.append(rct_id(
            0xA7DBD28C, 598, "battery.cells_stat[2].t_max.index", rct_data.t_uint8, "battery.cells_stat[2].t_max.index"))
        self.id_tab.append(rct_id(
            0xA7F4123B, 599, "battery_placeholder[0].stack_software_version[6]", rct_data.t_uint32, "Software version stack 6"))
        self.id_tab.append(rct_id(0xA7FA5C5D, 600, "power_mng.u_acc_mix_lp",
                           rct_data.t_float, "Battery voltage [V]"))
        self.id_tab.append(rct_id(
            0xA7FE5C0C, 601, "battery.cells_stat[2].t_min.index", rct_data.t_uint8, "battery.cells_stat[2].t_min.index"))
        self.id_tab.append(rct_id(
            0xA81176D0, 602, "battery_placeholder[0].cells_stat[1].u_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[1].u_min.time"))
        self.id_tab.append(rct_id(
            0xA83F291F, 603, "battery_placeholder[0].cells_stat[6].u_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[6].u_min.value"))
        self.id_tab.append(rct_id(
            0xA8FEAEB9, 604, "battery_placeholder[0].cells_resist[5]", rct_data.t_string, "battery_placeholder[0].cells_resist[5]"))
        ...
        self.id_tab.append(rct_id(
            0xAA911BEE, 609, "battery_placeholder[0].cells_stat[4].t_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[4].t_max.value"))
        self.id_tab.append(rct_id(
            0xAA9AA253, 610, "dc_conv.dc_conv_struct[1].p_dc", rct_data.t_float, "Solar generator B power [W]"))
        self.id_tab.append(rct_id(
            0xAACAC898, 611, "battery.cells_stat[4].t_max.time", rct_data.t_uint32, "battery.cells_stat[4].t_max.time"))
        ...
        self.id_tab.append(rct_id(
            0xABA015FC, 613, "battery_placeholder[0].module_sn[1]", rct_data.t_string, "Module 1 Serial Number"))
        self.id_tab.append(
            rct_id(0xAC2E2A56, 614, "io_board.rse_table[5]", rct_data.t_float, "K4..K1: 0101"))
        self.id_tab.append(rct_id(0xACF7666B, 615, "battery.efficiency",
                           rct_data.t_float, "Battery efficiency (used energy / stored energy)"))
        self.id_tab.append(rct_id(
            0xAE99F87A, 616, "battery_placeholder[0].cells_stat[5].t_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[5].t_min.time"))
        ...
        self.id_tab.append(rct_id(
            0xB130B8D6, 624, "battery_placeholder[0].cells_stat[1].t_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[1].t_min.time"))
        self.id_tab.append(rct_id(0xB1D1BE71, 625, "osci_struct.cmd_response_time",
                           rct_data.t_float, "osci_struct.cmd_response_time"))
        self.id_tab.append(rct_id(
            0xB1D465C7, 626, "battery_placeholder[0].cells_stat[4].u_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[4].u_min.value"))
        ...
        self.id_tab.append(rct_id(
            0xB228EC94, 630, "battery_placeholder[0].cells_stat[3].t_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[3].t_max.time"))
        self.id_tab.append(rct_id(0xB238942F, 631, "last_successfull_flash_op",
                           rct_data.t_int16, "last_successfull_flash_op"))
        self.id_tab.append(rct_id(
            0xB298395D, 632, "dc_conv.dc_conv_struct[0].u_sg_lp", rct_data.t_float, "Solar generator A voltage [V]"))
        ...
        self.id_tab.append(rct_id(
            0xB399B5B3, 634, "battery_placeholder[0].cells_stat[4].u_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[4].u_min.index"))
        self.id_tab.append(rct_id(
            0xB403A7E6, 635, "battery_placeholder[0].soc_update_since", rct_data.t_float, "battery_placeholder[0].soc_update_since"))
        ...
        self.id_tab.append(rct_id(
            0xB4E053D4, 639, "battery.cells_stat[1].u_min.value", rct_data.t_float, "battery.cells_stat[1].u_min.value"))
        self.id_tab.append(rct_id(
            0xB5317B78, 640, "dc_conv.dc_conv_struct[0].p_dc", rct_data.t_float, "Solar generator A power [W]"))
        ...
        self.id_tab.append(rct_id(
            0xB5EDA8EC, 643, "battery_placeholder[0].cells_stat[3].u_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[3].u_max.value"))
        ...
        self.id_tab.append(rct_id(
            0xB70D1703, 646, "battery_placeholder[0].cells_stat[5].u_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[5].u_max.index"))
        self.id_tab.append(rct_id(0xB76E2B4C, 647, "nsm.cos_phi_const",
                           rct_data.t_float, "Cos phi constant value (positive = overexcited)"))
        self.id_tab.append(rct_id(
            0xB7B2967F, 648, "energy.e_dc_total_sum[0]", rct_data.t_float, "energy.e_dc_total_sum[0]"))
        ...
        self.id_tab.append(rct_id(
            0xB81FB399, 651, "battery.cells_stat[2].u_min.time", rct_data.t_uint32, "battery.cells_stat[2].u_min.time"))
        ...
        self.id_tab.append(rct_id(0xB84FDCF9, 654, "adc.u_acc",
                           rct_data.t_float, "Battery voltage (inverter) [V]"))
        self.id_tab.append(
            rct_id(0xB851FA70, 655, "io_board.rse_table[11]", rct_data.t_float, "K4..K1: 1011"))
        ...
        self.id_tab.append(rct_id(
            0xB9E09F78, 659, "battery.cells_stat[5].u_min.index", rct_data.t_uint8, "battery.cells_stat[5].u_min.index"))
        self.id_tab.append(rct_id(
            0xBA046C03, 660, "battery_placeholder[0].cells_stat[5].t_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[5].t_max.value"))
        self.id_tab.append(rct_id(
            0xBA8B8515, 661, "dc_conv.dc_conv_struct[0].mpp.mpp_step", rct_data.t_float, "MPP search step on input A [V]"))
        self.id_tab.append(rct_id(
            0xBB302278, 662, "battery.cells_stat[1].t_min.time", rct_data.t_uint32, "battery.cells_stat[1].t_min.time"))
        ...
        self.id_tab.append(
            rct_id(0xBD95C46C, 672, "battery_placeholder[0].ah_capacity", rct_data.t_float, "Battery capacity [Ah]"))
        self.id_tab.append(rct_id(
            0xBDE3BF0A, 673, "battery.cells_stat[6].t_max.index", rct_data.t_uint8, "battery.cells_stat[6].t_max.index"))
        self.id_tab.append(
            rct_id(0xBDFE5547, 674, "io_board.rse_table[3]", rct_data.t_float, "K4..K1: 0011"))
        ...
        self.id_tab.append(rct_id(
            0xC04A5F3A, 678, "battery_placeholder[0].bms_software_version", rct_data.t_uint32, "Software version BMS Master"))
        self.id_tab.append(rct_id(
            0xC0680302, 679, "battery.cells_stat[2].t_min.time", rct_data.t_uint32, "battery.cells_stat[2].t_min.time"))
        ...
        self.id_tab.append(rct_id(
            0xC42F5807, 695, "battery.cells_stat[1].u_max.index", rct_data.t_uint8, "battery.cells_stat[1].u_max.index"))
        ...
        self.id_tab.append(rct_id(
            0xC56A1346, 700, "battery_placeholder[0].cells_stat[4].t_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[4].t_max.index"))
        ...
        self.id_tab.append(rct_id(
            0xC66665E8, 702, "battery_placeholder[0].temperature", rct_data.t_float, "Battery temperature [°C]"))
        self.id_tab.append(rct_id(0xC66A522B, 703, "hw_test.bt_time[1]",
                           rct_data.t_float, "hw_test.bt_time[1]"))
        self.id_tab.append(rct_id(
            0xC6DA81A0, 704, "battery.cells_stat[6].u_max.time", rct_data.t_uint32, "battery.cells_stat[6].u_max.time"))
        self.id_tab.append(rct_id(0xC707102E, 705, "hw_test.bt_power[3]",
                           rct_data.t_float, "hw_test.bt_power[3]"))
        self.id_tab.append(rct_id(
            0xC71155B5, 706, "battery_placeholder[0].cells_stat[2].t_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[2].t_min.index"))
        ...
        self.id_tab.append(rct_id(
            0xC7E85F32, 711, "battery_placeholder[0].cells_stat[4].t_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[4].t_max.time"))
        self.id_tab.append(rct_id(0xC8609C8E, 712, "battery.cells[3]",
                           rct_data.t_dump, "battery.cells[3]"))
        self.id_tab.append(rct_id(
            0xC88EB032, 713, "battery.cells_stat[0].u_min.time", rct_data.t_uint32, "battery.cells_stat[0].u_min.time"))
        self.id_tab.append(rct_id(
            0xC8BA1729, 714, "battery.stack_software_version[2]", rct_data.t_uint32, "Software version stack 2"))
        self.id_tab.append(rct_id(
            0xC8E56803, 715, "battery_placeholder[0].maximum_charge_voltage", rct_data.t_float, "Max. charge voltage [V]"))
        self.id_tab.append(rct_id(
            0xC937D38D, 716, "battery_placeholder[0].stack_cycles[0]", rct_data.t_uint16, "battery_placeholder[0].stack_cycles[0]"))
        self.id_tab.append(rct_id(0xC9900716, 717, "power_mng.is_island_only",
                           rct_data.t_bool, "Island without power switch support"))
        self.id_tab.append(rct_id(
            0xC9D76279, 718, "energy.e_dc_day_sum[0]", rct_data.t_float, "energy.e_dc_day_sum[0]"))
        self.id_tab.append(rct_id(
            0xCA4E0C03, 719, "battery_placeholder[0].cells_stat[5].u_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[5].u_max.time"))
        ...
        self.id_tab.append(rct_id(0xCB78F611, 723, "frt.t_max[1]",
                           rct_data.t_float, "Point 2 time [s]"))
        self.id_tab.append(rct_id(
            0xCB85C397, 724, "battery_placeholder[0].cells_stat[3].u_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[3].u_min.value"))
        self.id_tab.append(rct_id(0xCB9E1E6C, 725, "nsm.Q_const",
                           rct_data.t_float, "Constant reactive power [var] (positive = overexcited)"))
        self.id_tab.append(rct_id(
            0xCBBEEB21, 726, "battery_placeholder[0].cells_stat[2].u_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[2].u_max.time"))
        ...
        self.id_tab.append(rct_id(
            0xCD8EDAD3, 730, "battery_placeholder[0].cells_stat[3].t_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[3].t_min.value"))
        self.id_tab.append(rct_id(0xCE266F0F, 731, "power_mng.soc_min",
                           rct_data.t_float, "Min SOC target"))
        self.id_tab.append(rct_id(
            0xCE49EB86, 732, "battery_placeholder[0].cells_stat[2].t_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[2].t_max.index"))
        ...
        self.id_tab.append(rct_id(
            0xCF096A6B, 735, "battery_placeholder[0].stack_software_version[4]", rct_data.t_uint32, "Software version stack 4"))
        self.id_tab.append(rct_id(
            0xD0C47326, 736, "battery.cells_stat[1].t_min.value", rct_data.t_float, "battery.cells_stat[1].t_min.value"))
        ...
        self.id_tab.append(rct_id(
            0xD1F9D017, 741, "battery_placeholder[0].cells_stat[4].u_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[4].u_min.time"))
        self.id_tab.append(rct_id(
            0xD2DEA4B1, 742, "battery_placeholder[0].cells_stat[5].t_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[5].t_min.index"))
        ...
        self.id_tab.append(rct_id(
            0xD3F492EB, 745, "battery_placeholder[0].cells_stat[0].t_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[0].t_max.time"))
        self.id_tab.append(rct_id(0xD451EF88, 746, "cs_map[2]",
                           rct_data.t_uint8, "Associate current sensor 2 with phase L"))
        self.id_tab.append(
            rct_id(0xD45913EC, 747, "io_board.rse_table[13]", rct_data.t_float, "K4..K1: 1101"))
        ...
        self.id_tab.append(rct_id(
            0xD60E7A2F, 754, "battery.cells_stat[1].u_min.time", rct_data.t_uint32, "battery.cells_stat[1].u_min.time"))
        self.id_tab.append(rct_id(
            0xD81471DF, 755, "battery_placeholder[0].cells_stat[6].t_max.value", rct_data.t_float, "battery_placeholder[0].cells_stat[6].t_max.value"))
        self.id_tab.append(rct_id(
            0xD82F2D0B, 756, "battery_placeholder[0].cells_stat[3].u_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[3].u_min.index"))
        self.id_tab.append(rct_id(0xD83DC6AC, 757, "wifi.server_port",
                           rct_data.t_int32, "wifi.server_port"))
        self.id_tab.append(rct_id(
            0xD876A4AC, 758, "battery_placeholder[0].cells_stat[0].u_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[0].u_min.index"))
        ...
        self.id_tab.append(rct_id(
            0xDB11855B, 766, "dc_conv.dc_conv_struct[0].p_dc_lp", rct_data.t_float, "Solar generator A power [W]"))
        ...
        self.id_tab.append(rct_id(
            0xDD5930A2, 773, "battery.cells_stat[0].t_min.index", rct_data.t_uint8, "battery.cells_stat[0].t_min.index"))
        ...
        self.id_tab.append(rct_id(
            0xDE9CBCB0, 778, "battery.cells_stat[5].t_max.value", rct_data.t_float, "battery.cells_stat[5].t_max.value"))
        self.id_tab.append(rct_id(
            0xDEE1957F, 779, "battery.cells_resist[4]", rct_data.t_dump, "battery.cells_resist[4]"))
        ...
        self.id_tab.append(rct_id(
            0xDFF966E3, 783, "battery.cells_stat[6].t_min.index", rct_data.t_uint8, "battery.cells_stat[6].t_min.index"))
        ...
        self.id_tab.append(rct_id(
            0xE14F1CBA, 787, "battery_placeholder[0].cells_stat[4]", rct_data.t_string, "battery_placeholder[0].cells_stat[4]"))
        self.id_tab.append(rct_id(
            0xE19C8B79, 788, "battery_placeholder[0].cells_resist[1]", rct_data.t_string, "battery_placeholder[0].cells_resist[1]"))
        self.id_tab.append(rct_id(0xE1F49459, 789, "frt.t_min[2]",
                           rct_data.t_float, "Point 3 time [s]"))
        self.id_tab.append(
            rct_id(0xE24B00BD, 790, "power_mng.schedule[1]", rct_data.t_string, "power_mng.schedule[1]"))
        ...
        self.id_tab.append(
            rct_id(0xE31F8B17, 793, "prim_sm.Uzk_pump_grad[0]", rct_data.t_float, "start power [W]"))
        ...
        self.id_tab.append(rct_id(
            0xE635A6C4, 801, "battery_placeholder[0].module_sn[2]", rct_data.t_string, "Module 2 Serial Number"))
        ...
        self.id_tab.append(rct_id(0xE6F1CB83, 803, "nsm.pu_ts",
                           rct_data.t_float, "Time const for filter [s]"))
        self.id_tab.append(rct_id(
            0xE7177DEE, 804, "battery.cells_stat[2].u_max.value", rct_data.t_float, "battery.cells_stat[2].u_max.value"))
        self.id_tab.append(rct_id(0xE7B0E692, 805, "battery.bat_impedance.impedance_fine",
                           rct_data.t_float, "Battery circuit impedance"))
        self.id_tab.append(rct_id(
            0xE87B1F4B, 806, "battery_placeholder[0].cells_stat[0].u_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[0].u_min.value"))
        ...
        self.id_tab.append(rct_id(
            0xEA399EA8, 811, "battery_placeholder[0].min_cell_voltage", rct_data.t_float, "battery_placeholder[0].min_cell_voltage"))
        self.id_tab.append(rct_id(0xEA77252E, 812, "battery.minimum_discharge_voltage_constant_u",
                           rct_data.t_float, "Min. discharge voltage [V]"))
        self.id_tab.append(rct_id(
            0xEAEEB3CA, 813, "energy.e_dc_month_sum[0]", rct_data.t_float, "energy.e_dc_month_sum[0]"))
        self.id_tab.append(rct_id(
            0xEB4C2597, 814, "battery.cells_resist[6]", rct_data.t_dump, "battery.cells_resist[6]"))
        self.id_tab.append(rct_id(0xEB7773BF, 815, "nsm.p_u[1][1]",
                           rct_data.t_float, "Point 2 voltage [V]"))
        self.id_tab.append(
            rct_id(0xEB7BCB93, 816, "battery_placeholder[0].bms_sn", rct_data.t_string, "BMS Serial Number"))
        ...
        self.id_tab.append(rct_id(
            0xEEA3F59B, 821, "battery.stack_software_version[5]", rct_data.t_uint32, "Software version stack 5"))
        self.id_tab.append(rct_id(
            0xEEC44AA0, 822, "battery_placeholder[0].cells_stat[2].u_min.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[2].u_min.index"))
        self.id_tab.append(rct_id(
            0xEECDFEFC, 823, "battery.cells_stat[2].u_min.value", rct_data.t_float, "battery.cells_stat[2].u_min.value"))
        self.id_tab.append(rct_id(0xEF89568B, 824, "grid_mon[0].u_under.time",
                           rct_data.t_float, "Min. voltage switch-off time level 1 [s]"))
        self.id_tab.append(rct_id(
            0xEFD3EC8A, 825, "battery.cells_stat[5].t_min.time", rct_data.t_uint32, "battery.cells_stat[5].t_min.time"))
        ...
        self.id_tab.append(rct_id(
            0xF044EDA0, 828, "battery.cells_stat[3].t_max.value", rct_data.t_float, "battery.cells_stat[3].t_max.value"))
        ...
        self.id_tab.append(rct_id(
            0xF1DE6E99, 836, "battery_placeholder[0].cells_resist[3]", rct_data.t_string, "battery_placeholder[0].cells_resist[3]"))
        self.id_tab.append(rct_id(0xF1FA5BB9, 837, "grid_mon[1].f_under.time",
                           rct_data.t_float, "Min. frequency switch-off time level 2 [s]"))
        self.id_tab.append(rct_id(
            0xF23D4595, 838, "battery_placeholder[0].cells_stat[1].t_min.value", rct_data.t_float, "battery_placeholder[0].cells_stat[1].t_min.value"))
        ...
        self.id_tab.append(rct_id(0xF25591AA, 841, "nsm.cos_phi_p[3][0]",
                           rct_data.t_float, "Point 4 [P/Pn]"))
        self.id_tab.append(rct_id(
            0xF257D342, 842, "battery.cells_stat[1].t_max.value", rct_data.t_float, "battery.cells_stat[1].t_max.value"))
        ...
        self.id_tab.append(rct_id(
            0xF3FD8CE6, 848, "battery.cells_resist[2]", rct_data.t_dump, "battery.cells_resist[2]"))
        self.id_tab.append(rct_id(0xF42D4DD0, 849, "io_board.alarm_home_value",
                           rct_data.t_enum, "Evaluated value"))
        self.id_tab.append(rct_id(
            0xF451E935, 850, "battery_placeholder[0].cells_stat[0].t_min.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[0].t_min.time"))
        ...
        self.id_tab.append(rct_id(0xF49F58F2, 852, "nsm.p_u[2][1]",
                           rct_data.t_float, "Point 3 voltage [V]"))
        self.id_tab.append(
            rct_id(0xF52C0B50, 853, "power_mng.schedule[7]", rct_data.t_string, "power_mng.schedule[7]"))
        self.id_tab.append(rct_id(
            0xF54BC06D, 854, "battery.cells_stat[4].u_max.value", rct_data.t_float, "battery.cells_stat[4].u_max.value"))
        ...
        self.id_tab.append(rct_id(
            0xF677D737, 857, "battery_placeholder[0].cells_stat[6].u_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[6].u_max.time"))
        self.id_tab.append(rct_id(
            0xF68ECC1F, 858, "battery_placeholder[0].cells_stat[1].u_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[1].u_max.time"))
        self.id_tab.append(rct_id(0xF6A85818, 859, "nsm.f_entry",
                           rct_data.t_float, "Entry frequency for P(f) over-frequency mode [Hz]"))
        self.id_tab.append(rct_id(
            0xF742C6BA, 860, "battery_placeholder[0].cells_stat[1].u_max.index", rct_data.t_uint8, "battery_placeholder[0].cells_stat[1].u_max.index"))
        ...
        self.id_tab.append(
            rct_id(0xF99E8CC8, 866, "battery.cells_stat[6]", rct_data.t_string, "battery.cells_stat[6]"))
        self.id_tab.append(rct_id(0xF9FD0D61, 867, "wifi.service_ip",
                           rct_data.t_string, "wifi.service_ip"))
        self.id_tab.append(rct_id(
            0xFA3276DC, 868, "battery.cells_stat[3].t_min.time", rct_data.t_uint32, "battery.cells_stat[3].t_min.time"))
        ...
        self.id_tab.append(rct_id(0xFAA837C8, 870, "nsm.f_low_rise_grad",
                           rct_data.t_float, "Power rise gradient for P(f) under-frequency mode without battery [1/Pn*Hz]"))
        ...
        self.id_tab.append(
            rct_id(0xFB796780, 874, "battery.cells_stat[1]", rct_data.t_string, "battery.cells_stat[1]"))
        ...
        self.id_tab.append(rct_id(
            0xFC1F8C65, 880, "battery_placeholder[0].cells_stat[6].t_max.time", rct_data.t_uint32, "battery_placeholder[0].cells_stat[6].t_max.time"))
        ...
        self.id_tab.append(
            rct_id(0xFCA1CBB5, 883, "battery_placeholder[0].voltage", rct_data.t_float, "Battery voltage [V]"))
        ...
        self.id_tab.append(rct_id(
            0xFDBD9EE9, 889, "battery.cells_stat[3].u_max.index", rct_data.t_uint8, "battery.cells_stat[3].u_max.index"))
        ...
        self.id_tab.append(rct_id(
            0xFE38B227, 891, "battery_placeholder[0].cells_stat[5]", rct_data.t_string, "battery_placeholder[0].cells_stat[5]"))
        self.id_tab.append(rct_id(
            0xFE44BA26, 892, "battery.cells_stat[0].u_min.index", rct_data.t_uint8, "battery.cells_stat[0].u_min.index"))
        self.id_tab.append(rct_id(
            0xFED51BD2, 893, "dc_conv.dc_conv_struct[1].enabled", rct_data.t_bool, "Solar generator B connected"))
        self.id_tab.append(rct_id(0xFF2A258B, 894, "wifi.server_ip",
                           rct_data.t_string, "wifi.server_ip"))
        self.id_tab.append(rct_id(
            0xFF5B8A54, 895, "battery_placeholder[0].cells_stat[3]", rct_data.t_string, "battery_placeholder[0].cells_stat[3]"))
