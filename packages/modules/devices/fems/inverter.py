...
class FemsInverter:
    def __init__(self, device_id: int, component_config: Union[Dict, FemsInverterSetup]) -> None:
        self.__device_id = device_id
        self.component_config = dataclass_from_dict(FemsInverterSetup, component_config)
