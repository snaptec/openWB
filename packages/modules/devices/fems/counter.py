...
class FemsCounter:
    def __init__(self, device_id: int, component_config: Union[Dict, FemsCounterSetup]) -> None:
        self.__device_id = device_id
        self.component_config = dataclass_from_dict(FemsCounterSetup, component_config)
