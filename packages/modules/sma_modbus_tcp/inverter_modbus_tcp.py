...
from modules.sma_modbus_tcp.config import SmaModbusTcpInverterSetup
...
class SmaModbusTcpInverter:
    ...
    def __init__(self,
                 device_id: int,
                 device_address: str,
                 component_config: Union[Dict, SmaModbusTcpInverterSetup]) -> None:
        self.__device_id = device_id
        self.component_config = dataclass_from_dict(SmaModbusTcpInverterSetup, component_config)
...
component_descriptor = ComponentDescriptor(configuration_factory=SmaModbusTcpInverterSetup)
